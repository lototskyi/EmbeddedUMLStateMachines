...
static QState Clock_Alarm_alarm_err_off(Clock_Alarm * const me);
static QState Clock_Alarm_alarm_err_on(Clock_Alarm * const me);
...
static QState Clock_Alarm_as_error(Clock_Alarm * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        case Q_INIT_SIG: {
            status_ = Q_TRAN(&Clock_Alarm_alarm_err_on);
            break;
        }
...
/*.${HSMs::Clock_Alarm::SM::Clock::Settings::Alarm_Setting::as_error::alarm_err_off} */
static QState Clock_Alarm_alarm_err_off(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::Alarm_Setting::as_error::alarm_err_off} */
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::Alarm_Setting::as_error::alarm_err_off::TICK} */
        case TICK_SIG: {
            ++me->timeout;
            /*.${HSMs::Clock_Alarm::SM::Clock::Settings::Alarm_Setting::as_error::alarm_err_off::TICK::[me->timeout==10]} */
            if (me->timeout == 10) {
                me->timeout = 0;
                status_ = Q_TRAN(&Clock_Alarm_alarm_err_on);
            }
...
/*.${HSMs::Clock_Alarm::SM::Clock::Settings::Alarm_Setting::as_error::alarm_err_on} */
static QState Clock_Alarm_alarm_err_on(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::Alarm_Setting::as_error::alarm_err_on} */
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::Alarm_Setting::as_error::alarm_err_on::TICK} */
        case TICK_SIG: {
            ++me->timeout;
            /*.${HSMs::Clock_Alarm::SM::Clock::Settings::Alarm_Setting::as_error::alarm_err_on::TICK::[me->timeout==10]} */
            if (me->timeout == 10) {
                me->timeout = 0;
                status_ = Q_TRAN(&Clock_Alarm_alarm_err_off);
            }
            else {
                status_ = Q_UNHANDLED();
            }
