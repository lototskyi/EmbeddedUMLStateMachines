...
#endif
/*.$endskip${QP_VERSION} ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^*/
/*.$define${HSMs::AO_ClockAlarm} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv*/
/*.${HSMs::AO_ClockAlarm} ..................................................*/
QActive *const AO_ClockAlarm  = &Clock_Alarm_obj.super;
/*.$enddef${HSMs::AO_ClockAlarm} ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^*/
...
static QState Clock_Alarm_Clock(Clock_Alarm * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::initial} */
        case Q_INIT_SIG: {
...
/*.${HSMs::Clock_Alarm::SM::Clock::Settings::hd2} ..........................*/
static QState Clock_Alarm_hd2(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::hd2} */
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::hd2::SET} */
        case SET_SIG: {
            ++me->temp_digit;
            me->temp_digit %= 10;
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::hd2::OK} */
        case OK_SIG: {
...
/*.${HSMs::Clock_Alarm::SM::Clock::Settings::md1} ..........................*/
static QState Clock_Alarm_md1(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::md1} */
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::md1::SET} */
        case SET_SIG: {
            ++me->temp_digit;
            me->temp_digit %= 6;
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::md1::OK} */
        case OK_SIG: {
...
/*.${HSMs::Clock_Alarm::SM::Clock::Settings::md2} ..........................*/
static QState Clock_Alarm_md2(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::md2} */
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::md2::SET} */
        case SET_SIG: {
            ++me->temp_digit;
            me->temp_digit %= 10;
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::md2::OK} */
        case OK_SIG: {
...
/*.${HSMs::Clock_Alarm::SM::Clock::Settings::sd2} ..........................*/
static QState Clock_Alarm_sd2(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::sd2} */
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::sd2::SET} */
        case SET_SIG: {
            ++me->temp_digit;
            me->temp_digit %= 10;
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::sd2::OK} */
        case OK_SIG: {
...
/*.${HSMs::Clock_Alarm::SM::Clock::Settings::clock_format} .................*/
static QState Clock_Alarm_clock_format(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::clock_format} */
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::clock_format::SET} */
        case SET_SIG: {
            String msg;
            if(me->temp_format == FORMAT_24H){
                me->temp_format = FORMAT_AM;
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::clock_format::OK} */
        case OK_SIG: {
            /*.${HSMs::Clock_Alarm::SM::Clock::Settings::clock_format::OK::[is_time_set_error(me->temp_time~} */
            if (is_time_set_error(me->temp_time,(time_format_t)me->temp_format)) {
                status_ = Q_TRAN(&Clock_Alarm_setting_error);
            }
            /*.${HSMs::Clock_Alarm::SM::Clock::Settings::clock_format::OK::[else]} */
            else {
                /*.${HSMs::Clock_Alarm::SM::Clock::Settings::clock_format::OK::[else]::[me->curr_setting==ALARM_SETTING~} */
...
/*.${HSMs::Clock_Alarm::SM::Clock::Settings::setting_error} ................*/
static QState Clock_Alarm_setting_error(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::setting_error} */
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::setting_error::initial} */
        case Q_INIT_SIG: {
            status_ = Q_TRAN(&Clock_Alarm_err_on);
            break;
        }
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::setting_error::SET} */
        case SET_SIG: {
            display_cursor_on_blinkon();
            status_ = Q_TRAN(&Clock_Alarm_Settings);
            break;
        }
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::setting_error::OK} */
        case OK_SIG: {
            status_ = Q_HANDLED();
            break;
        }
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::setting_error::TICK} */
        case TICK_SIG: {
            Q_SIG(&me->alarm) = ALARM_CHECK_SIG;
            Q_PAR(&me->alarm) = Clock_Alarm_get_curr_time()/10;
            Alarm_dispatch(&me->alarm);
...
/*.${HSMs::Clock_Alarm::SM::Clock::Settings::setting_error::err_off} .......*/
static QState Clock_Alarm_err_off(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::setting_error::err_off} */
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::setting_error::err_off::Q_TIMEOUT} */
        case Q_TIMEOUT_SIG: {
            status_ = Q_TRAN(&Clock_Alarm_err_on);
            break;
        }
...
/*.${HSMs::Clock_Alarm::SM::Clock::Settings::setting_error::err_on} ........*/
static QState Clock_Alarm_err_on(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::setting_error::err_on} */
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::setting_error::err_on::Q_TIMEOUT} */
        case Q_TIMEOUT_SIG: {
...
/*.${HSMs::Clock_Alarm::SM::Clock::Settings::hd1} ..........................*/
static QState Clock_Alarm_hd1(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::hd1} */
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::hd1::SET} */
        case SET_SIG: {
            ++me->temp_digit;
            me->temp_digit %= 3;
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::hd1::OK} */
        case OK_SIG: {
...
/*.${HSMs::Clock_Alarm::SM::Clock::Settings::sd1} ..........................*/
static QState Clock_Alarm_sd1(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::sd1} */
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::sd1::SET} */
        case SET_SIG: {
            ++me->temp_digit;
            me->temp_digit %= 6;
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::sd1::OK} */
        case OK_SIG: {
...
/*.${HSMs::Clock_Alarm::SM::Clock::Settings::alarm_on_off} .................*/
static QState Clock_Alarm_alarm_on_off(Clock_Alarm * const me) {
    QState status_;
    switch (Q_SIG(me)) {
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::alarm_on_off} */
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::alarm_on_off::SET} */
        case SET_SIG: {
            if(me->temp_digit){
                display_write("ALARM OFF",ALARM_SETTING_STATUS_ROW,ALARM_SETTING_STATUS_COL);
                me->temp_digit = 0;
...
static QState Clock_Alarm_Alarm_Notify(Clock_Alarm * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        /*.${HSMs::Clock_Alarm::SM::Alarm_Notify::Q_TIMEOUT} */
        case Q_TIMEOUT_SIG: {
...
static QState Clock_Alarm_alarm_msg_on(Clock_Alarm * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        /*.${HSMs::Clock_Alarm::SM::Alarm_Notify::alarm_msg_on::Q_TIMEOUT} */
        case Q_TIMEOUT_SIG: {
            --me->timeout;
            /*.${HSMs::Clock_Alarm::SM::Alarm_Notify::alarm_msg_on::Q_TIMEOUT::[me->timeout]} */
            if (me->timeout) {
...
static QState Clock_Alarm_alarm_msg_off(Clock_Alarm * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        /*.${HSMs::Clock_Alarm::SM::Alarm_Notify::alarm_msg_off::Q_TIMEOUT} */
        case Q_TIMEOUT_SIG: {
            status_ = Q_TRAN(&Clock_Alarm_alarm_msg_on);
            break;
        }
